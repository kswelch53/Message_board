...
def index(request):
    ...
    return render(request, 'wall_one/index.html')


# logs in user if validations are met
def login(request):
    print("This is login function in wall_one views.py")
    ...
    if response_from_models['status']:#if true (validations are met):
        ...
        return redirect('wall_one:index')


# saves a user object if registration validations are met
def register(request):
    print("This is register function in wall_one views.py")
